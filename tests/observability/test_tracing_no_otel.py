...
def test_noop_tracer_without_otel():
    ...
    from mlsdm.observability.tracing import OTEL_AVAILABLE, get_tracer_manager, NoOpTracer
...
def test_trace_context_without_otel():
    ...
    from mlsdm.observability.logger import get_current_trace_context, OTEL_AVAILABLE
...
def test_no_otel_in_sys_modules():
    ...
    try:
        ...
        from mlsdm.observability import tracing, logger
        from mlsdm import LLMWrapper
...
def test_tracer_manager_disabled_state():
    ...
    from mlsdm.observability.tracing import TracingConfig, TracerManager, OTEL_AVAILABLE

...
```bash
$ python scripts/ci_perf_resilience_gate.py --pr-url https://github.com/neuron7x/mlsdm/pull/100
...
```bash
$ python scripts/ci_perf_resilience_gate.py --pr-url https://github.com/neuron7x/mlsdm/pull/200
...
```bash
$ python scripts/ci_perf_resilience_gate.py --pr-url https://github.com/neuron7x/mlsdm/pull/300

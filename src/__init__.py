"""MLSDM Governed Cognitive Memory - Production-ready neurobiologically-grounded cognitive architecture.

This package provides a universal wrapper for any LLM with hard biological constraints,
including moral governance, phase-based memory, and circadian rhythm.
"""
...
# Cognitive Controller - Low-level direct access

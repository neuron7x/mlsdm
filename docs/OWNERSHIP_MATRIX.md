...
| Subsystem | Responsibility | Canonical spec/contracts |
| --- | --- | --- |
...
| `security/` | Governance and safety guardrails. | `docs/SECURITY_POLICY.md`, `SAFETY_POLICY.yaml` |
...
- Update contracts/specs in the same change set.
- Include evidence in the PR (tests + updated docs).
